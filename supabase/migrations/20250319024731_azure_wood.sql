/*
  ...
  1. Changes
    ...
    - Create new non-recursive policies using LEFT JOIN LATERAL
    - Add proper permissions for auth and public roles
...
-- Create admin policy with LEFT JOIN LATERAL to prevent recursion
